...
// Acceleration
  {"le.add", "rD,rA,rB", "11 0xE  DDDDD AAAAA BBBB B-00--0-0000",
   EF (le_add), 0, it_unknown},
  {"le.and", "rD,rA,rB", "11 0xE  DDDDD AAAAA BBBB B-00--0-0011",
   EF (le_and), 0, it_unknown},
  {"le.not", "rD,rA",    "11 0xE  DDDDD AAAAA ---- --00--0-0110",
   EF (le_not), 0, it_unknown},
  {"le.or",  "rD,rA,rB", "11 0xE  DDDDD AAAAA BBBB B-00--0-0100,
   EF (le_or), 0, it_unknown},
  {"le.cmov","rD,rA,rB", "11 0xE  DDDDD AAAAA BBBB B-00--0-1110",
   EF (le_cmov), 0, it_unknown},
  {"le.dec", "rD",       "11 0xE  DDDDD ----- ---- --00--0-1101",
   EF (le_dec), 0, it_unknown},
  {"le.divs","rD,rA,rB", "11 0xE  DDDDD AAAAA BBBB B-11--0-1001",
   EF (le_divs), 0, it_unknown},
  {"le.divu","rD,rA,rB", "11 0xE  DDDDD AAAAA BBBB B-11--0-1010",
   EF (le_divu), 0, it_unknown},
  {"le.eq",  "rD,rA,rB", "11 0xE  DDDDD AAAAA BBBB B-01--0-1110",
   EF (le_eq), 0, it_unknown},
  {"le.xor", "rD,rA,rB", "11 0xE  DDDDD AAAAA BBBB B-00--0-0101",
   EF (le_xor), 0, it_unknown},
  {"le.pows","rD,rA,rB", "11 0xE  DDDDD AAAAA BBBB B-11--0-1100",
   EF (le_pows), 0, it_unknown},
  {"le.powu","rD,rA,rB", "11 0xE  DDDDD AAAAA BBBB B-11--0-1101",
   EF (le_powu), 0, it_unknown},
  {"le.ff1", "rD,rA",    "11 0xE  DDDDD AAAAA ---- --00--0-1111",
   EF (le_ff1), 0, it_unknown},
  {"le.fl1", "rD,rA",    "11 0xE  DDDDD AAAAA ---- --01--0-1111",
   EF (le_fl1), 0, it_unknown},
  {"le.gcd", "rD,rA,rB", "11 0xE  DDDDD AAAAA BBBB B-10--0-1010",
   EF (le_gcd), 0, it_unknown},
  {"le.ges", "rD,rA,rB", "11 0xE  DDDDD AAAAA BBBB B-01--0-1011",
   EF (le_ges), 0, it_unknown},
  {"le.geu", "rD,rA,rB", "11 0xE  DDDDD AAAAA BBBB B-00--0-1011",
   EF (le_geu), 0, it_unknown},
  {"le.gts", "rD,rA,rB", "11 0xE  DDDDD AAAAA BBBB B-01--0-1100",
   EF (le_gts), 0, it_unknown},
  {"le.gtu", "rD,rA,rB", "11 0xE  DDDDD AAAAA BBBB B-00--0-1100",
   EF (le_gtu), 0, it_unknown},
  {"le.inc", "rD",       "11 0xE  DDDDD ----- ---- --00--0-0001",
   EF (le_inc), 0, it_unknown},
  {"le.les", "rD,rA,rB", "11 0xE  DDDDD AAAAA BBBB B-01--0-1001",
   EF (le_les), 0, it_unknown},
  {"le.leu", "rD,rA,rB", "11 0xE  DDDDD AAAAA BBBB B-00--0-1001",
   EF (le_leu), 0, it_unknown},
  {"le.lts", "rD,rA,rB", "11 0xE  DDDDD AAAAA BBBB B-01--0-0111",
   EF (le_lts), 0, it_unknown},
  {"le.ltu", "rD,rA,rB", "11 0xE  DDDDD AAAAA BBBB B-00--0-0111",
   EF (le_ltu), 0, it_unknown},
  {"le.land","rD,rA,rB", "11 0xE  DDDDD AAAAA BBBB B-01--0-0011",
   EF (le_land), 0, it_unknown},
  {"le.lnot","rD,rA",    "11 0xE  DDDDD AAAAA ---- --01--0-0110",
   EF (le_lnot), 0, it_unknown},
  {"le.lor", "rD,rA,rB", "11 0xE  DDDDD AAAAA BBBB B-01--0-0100",
   EF (le_lor), 0, it_unknown},
  {"le.mods","rD,rA,rB", "11 0xE  DDDDD AAAAA BBBB B-01--0-1010",
   EF (le_mods), 0, it_unknown},
  {"le.modu","rD,rA,rB", "11 0xE  DDDDD AAAAA BBBB B-00--0-1010",
   EF (le_modu), 0, it_unknown},
  {"le.macs","rD,rA,rB", "11 0xE  DDDDD AAAAA BBBB B-11--0-0001",
   EF (le_macs), 0, it_unknown},
  {"le.macu","rD,rA,rB", "11 0xE  DDDDD AAAAA BBBB B-11--0-0011",
   EF (le_macu), 0, it_unknown},
  {"le.msbs","rD,rA,rB", "11 0xE  DDDDD AAAAA BBBB B-11--0-0010",
   EF (le_msbs), 0, it_unknown},
  {"le.msbu","rD,rA,rB", "11 0xE  DDDDD AAAAA BBBB B-11--0-0100",
   EF (le_msbu), 0, it_unknown},
  {"le.muls","rD,rA,rB", "11 0xE  DDDDD AAAAA BBBB B-11--0-0110",
   EF (le_muls), 0, it_unknown},
  {"le.mulu","rD,rA,rB", "11 0xE  DDDDD AAAAA BBBB B-11--0-1011",
   EF (le_mulu), 0, it_unknown},
  {"le.ne",  "rD,rA,rB", "11 0xE  DDDDD AAAAA BBBB B-01--0-0101",
   EF (le_ne), 0, it_unknown},
  {"le.rand","rD,rA,rB", "11 0xE  DDDDD ----- ---- --10--0-0000",
   EF (le_rand), 0, it_unknown},
  {"le.ror", "rD,rA,rB", "11 0xE  DDDDD AAAAA BBBB B-11--0-1000",
   EF (le_ror), 0, it_unknown},
  {"le.sll", "rD,rA,rB", "11 0xE  DDDDD AAAAA BBBB B-00--0-1000",
   EF (le_sll), 0, it_unknown},
  {"le.sra", "rD,rA,rB", "11 0xE  DDDDD AAAAA BBBB B-10--0-1000",
   EF (le_sra), 0, it_unknown},
  {"le.srl", "rD,rA,rB", "11 0xE  DDDDD AAAAA BBBB B-01--0-1000",
   EF (le_srl), 0, it_unknown},
  {"le.sub", "rD,rA,rB", "11 0xE  DDDDD AAAAA BBBB B-00--0-0010",
